...
import {switchsaves} from '../models';
...
export function BackupSwitchSelection(arg1:Array<main.SwitchSelection>):Promise<Array<switchsaves.BackupResult>>;
...
export function ExtractSwitchBackupToPC(arg1:string,arg2:string):Promise<switchsaves.DownloadResult>;
...
export function GetSwitchStatus():Promise<main.SwitchStatus>;

export function GetSwitchTitleEntries(arg1:string):Promise<Array<switchsaves.Entry>>;
...
export function ListSwitchBackups():Promise<Array<switchsaves.Backup>>;
...
export function PreviewSwitchUpload(arg1:string,arg2:string,arg3:string):Promise<switchsaves.UploadPlan>;
...
export function RestoreSwitchBackupToConsole(arg1:string,arg2:string,arg3:string):Promise<switchsaves.UploadPlan>;
...
export function ScanSwitch():Promise<switchsaves.Library>;
...
export function TransferPCToSwitch(arg1:string,arg2:string,arg3:string):Promise<switchsaves.UploadPlan>;

export function TransferSwitchToPC(arg1:string,arg2:string,arg3:string):Promise<switchsaves.DownloadResult>;
